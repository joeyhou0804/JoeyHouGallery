...
// All dimensional CSS values scale with viewport width so the layout
// looks identical at every screen size within a breakpoint tier.
//
// Two-tier system (mobile / desktop), split at md = 768px:
//   mobile  (xs, <768px):  reference 390px
//   desktop (md, ≥768px):  reference 1512px
...
/**
 * Responsive object for MUI sx:
 *   rvw(40, 64) → { xs: 'calc(100vw * 40 / 390)', md: 'calc(100vw * 64 / 1512)' }
 */
